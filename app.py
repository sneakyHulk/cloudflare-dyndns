...
def main():
    ...
    try:
        ...
        if ipv4 is not None and not a_record:
            print('A record for {} does not exist.'.format(zone))
        ...
        if ipv6 is not None and not aaaa_record:
            print('AAAA record for {} does not exist.'.format(zone))
